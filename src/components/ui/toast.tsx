...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-1 top-1 rounded-md p-1 text-foreground outline-none focus:ring-1 group-[.destructive]:text-red-50 group-[.destructive]:ring-red-400 group-[.destructive]:ring-offset-red-600",
      className
    )}
    toast-close=""
    {...props}
